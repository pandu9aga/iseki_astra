            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-dark border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Area Table</h6>
                    </div>
                </div>
                <div class="card-body px-0 pb-2">
                        ...
                        <table id="example" class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center text-uppercase text-primary text-xxs font-weight-bolder opacity-7">Angle</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 20%;">
                                        <p class="text-xs text-primary mb-0">{{ $a->Name_Area }}</p>
                                    </td>
                                    <td style="overflow-y: auto; max-height: 60px; white-space: normal;">
                                        <p class="text-xs text-primary mb-0">
                                            @foreach ($a->area_photo as $photo)
                                                {{ $photo->photo_angle->Name_Photo_Angle ?? 'Not Found' }}@if (!$loop->last), @endif
                                            @endforeach
                                        </p>
                                    </td>
                                    <td class="align-middle text-center">
                                        <div class="d-flex justify-content-center">
                                            <a href="{{ route('area.edit', $a->Id_Area) }}"
                    ...
                    <br>
                    <a class="btn btn-primary mx-3" href="{{ route('area.add') }}">
