...
<div class="container-fluid py-2">
    ...
    <div class="page-header min-height-300 border-radius-xl mt-4"
        ...
        <div class="position-relative z-index-1 p-4">
            <h2 class="text-primary">Angle</h2>
        </div>
    ...
    <div class="card card-body mx-2 mx-md-2 mt-n6">
        <div class="row gx-4 mb-2">
            <div class="col-auto">
                <h4 class="text-secondary mx-2">Add Angle</h4>
            </div>
            ...
            <div class="col-12 col-lg-4">
                <div class="card card-plain h-100">
                    ...
                    <div class="card-body p-3">
                        ...
                        @endif
                        <form role="form" class="text-start" action="{{ route('angle.create') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="input-group input-group-outline my-3">
                                <label class="form-label">Angle Name</label>
                                <input type="text" class="form-control" name="Name_Photo_Angle" value="">
                            </div>
                            <div class="input-group input-group-outline my-3">
                                <label class="form-label">Angle Icon</label>
                                <input type="text" class="form-control" name="Icon_Photo_Angle" value="">
                            </div>
