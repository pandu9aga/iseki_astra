            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-dark border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Angle Table</h6>
                    </div>
                </div>
                <div class="card-body px-0 pb-2">
                        ...
                        <table id="example" class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-primary text-xxs font-weight-bolder opacity-7">Name Angle</th>
                                    <th class="text-uppercase text-primary text-xxs font-weight-bolder opacity-7">Icon Angle</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-xs text-primary mb-0">{{ $a->Name_Photo_Angle }}</p>
                                    </td>
                                    <td>
                                        <p class="text-xs text-primary mb-0">{{ $a->Icon_Photo_Angle }} <span><i class="material-symbols-rounded">{{ $a->Icon_Photo_Angle }}</i></span></p>
                                    </td>
                                    <td class="align-middle text-center">
                                        <div class="d-flex justify-content-center">
                                            <a href="{{ route('angle.edit', $a->Id_Photo_Angle) }}"
                    ...
                    <br>
                    <a class="btn btn-primary mx-3" href="{{ route('angle.add') }}">
