...
document.querySelectorAll('.image-input').forEach(input => {
    ...
    input.addEventListener('change', async function(e) {
        ...
        // Tentukan target size berdasarkan area (Engine: 500KB, Lainnya: 1MB)
        const areaName = document.getElementById('Name_Area').value.trim();
        const maxSize = (areaName === 'Engine') ? 500 * 1024 : 1024 * 1024;
